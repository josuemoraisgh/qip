...
class TelasPage1 extends StatefulWidget {
  final TelasController? controller;
  final int? id;
  const TelasPage1({super.key, required this.id, this.controller});

  @override
  State<TelasPage1> createState() => _TelasPage1State();
}

class _TelasPage1State extends State<TelasPage1> {
