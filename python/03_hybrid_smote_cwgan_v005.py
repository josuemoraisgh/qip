...
import sys
try:
    import msvcrt  # Windows: leitura de teclado não-bloqueante
    _HAS_MSVCRT = True
except Exception:
    _HAS_MSVCRT = False
...
def main():
    ...
    # SMOTE
    ap.add_argument("--smote-min-per-class", type=int, default=600,
                    help="Número mínimo de amostras por classe após SMOTE (padrão: 600).")
