...
# v012_fix: mantém treino no X_sm (oversampled) e evita zero-batch (drop_last=False).
# Também inclui fit_resample_balanced e todo o pipeline (MinMax, GOLDEN, integers 0..10, etc.).
...
def main():
    ap = argparse.ArgumentParser(description="Hybrid SMOTE + cWGAN-GP (v012_fix: mantém treino em X_sm e evita zero-batch)")
