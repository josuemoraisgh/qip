...
def main(args):
    ...
    print(f"[ALVO] meta para parar: TR>= {TARGET_MACRO_TOPK:.0%} e VA>= {TARGET_MACRO_TOPK:.0%}")
    ...
    for it in range(1, MAX_ITERS+1):
        ...
        if it % CHECK_EVERY == 0 or it == 1 or it == MAX_ITERS:
            ...
            if (best_score_tr >= TARGET_MACRO_TOPK) and (best_score_va >= TARGET_MACRO_TOPK):
                print("[PARAR] Atingiu meta (TR e VA)."); break
